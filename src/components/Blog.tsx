          ...
          <div className="slideshow-wrapper-blog">
            ...
            <div className="slide-blog">
              <div className="mt-8">
                ...
                Explore cryptography essentials: from encryption techniques and digital signatures to 
                hash functions and digital certificates, uncovering the tools that safeguard digital communication and data integrity.
                </p>
 ...
 */}
      ...
      <div className="w-100 mt-8 md:max-w-xs lg:max-w-none hello   h-[7%]">
        <a href="https://quantumloom.medium.com" target='blank'>
        <button
          type="button"
